...
def ver_tarea(request, tid):
    tarea = Tarea.objects.get(id=tid)

    return render(request, 'tareasapp/detalle.html', {'tarea': tarea}) 

def editar_tarea(request, tid):
    tarea = Tarea.objects.get(id=tid)
    ...
    return render(request, 'tareasapp/editar.html', {'tarea': tarea}) 
